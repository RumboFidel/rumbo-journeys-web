...
import type { BitacoraItemWeb, CantonWeb, CarreraWeb, HistoriaWeb, MedioWeb, ResumenWeb } from "./types";
...
import bitacoraData from "./generated/rumbo-web/bitacora.json";
...
export const BITACORA_WEB: BitacoraItemWeb[] = (bitacoraData as { items: BitacoraItemWeb[] }).items;
